...
public class Token {
    ...
    private static final String METRIC_TOKEN_SEPARATOR_REGEX = "\\.";
    private static final String METRIC_TOKEN_SEPARATOR = ".";
    ...
    private String joinTokens(String prefix, String suffix, String[] tokens, int level) {
        return Arrays.stream(tokens)
                .limit(level)
                .collect(joining(METRIC_TOKEN_SEPARATOR, prefix, suffix));
    }
    ...
    public static List<Token> getTokens(Locator locator) {
        ...
        String[] tokens = locator.getMetricName().split(METRIC_TOKEN_SEPARATOR_REGEX);
